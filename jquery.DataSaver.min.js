...
JSON.stringify(e)].join(".");a[b]=d}return d}var f="DataSaver",k={init:function(a){var b=c.extend({timeout:0,events:"change"},a);return this.each(function(a,e){l(e);"undefined"!==typeof b.events&&0<b.events.length&&(b.events=b.events.split(",").join(" "),e[f+"_events"]=b.events,c(document.body).on(b.events,e,function(){g(e)}));"number"===typeof b.timeout&&0<b.timeout&&(e[f+"_timeout"]=setInterval(function(){g(e)},b.timeout))})},die:function(){return this.each(function(a,b){c(document.body).off(b[f+
"_events"]);clearInterval(b[f+"_timeout"])})},load:function(){return this.each(function(a,b){l(b)})},save:function(){return this.each(function(a,b){g(b)})},remove:function(){return this.each(function(a,b){var d=h(b);localStorage.removeItem(d);c(b).trigger(f+"_remove")})}};c.fn.DataSaver=function(a){"localStorage"in window&&null!==window.localStorage||c.error("Your browser doesn't support localStorage.");if(k[a])return k[a].apply(this,Array.prototype.slice.call(arguments,1));if("object"!==typeof a&&
a)c.error('Method "'+a+'" does not exist on '+f+".");else return k.init.apply(this,arguments)}})(jQuery);