...
case "save":return this.save();case "remove":return this.remove();case "stop":return this.stop();default:return this.start()}};a.fn[d]=function(b){"localStorage"in f&&null!==f.localStorage||a.error("Your browser doesn't support localStorage.");return this.each(function(){a.data(this,"plugin_"+d)&&"string"!==typeof b||a.data(this,"plugin_"+d,new e(this,b))})}})(jQuery,window,document);